...
public class matrix
{
	public static void main(String [] args)
	{
        ...
        System.out.println("The result for 1(a): ");
        print_2d_array(C);
        ...
        System.out.println("Time for multiplication of 16x16 matrices: " + elapsed_time + " ns");
        ...
        System.out.println("Time for multiplication of 64x64 matrices: " + elapsed_time + " ns");
        ...
        System.out.println("Time for multiplication of 16x16 matrices using square matrix multiplication: " + elapsed_time + " ns");
        ...
        System.out.println("Time for multiplication of 64x64 matrices using square matrix multiplication: " + elapsed_time + " ns");
	...
	public static void strassen_matrix_multiply(int [][] A, int [][] B, int [][] C)
	{
        ...
        strassen_matrix_multiply(temp, S3, P3);
        //P4
